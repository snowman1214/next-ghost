            ...
            <div className="research-container wrapper">
              <div className="b-hero-cta s:grid s:grid-12">
                ...
                <div className="description-wrapper s:col-start-4 s:col-span-6 spacer-medium-mt text-b1">
                  <p>
                    We develop large-scale AI systems so that we can study their
                    safety properties at the technological frontier, where new
                    problems are most likely to arise. We use these insights to
                    create safer, steerable, and more reliable models, and to
                    generate systems that we deploy externally, like Claude.
                  </p>
                </div>
                ...
                <div className="panel" tabIndex="-1">
                  <div className="principle">
                    ...
                    <p className="text-b2 spacer-micro-mt">
                      ...
                      to help us do systematic, empirically-driven research. We
                      search for simple relations among data, compute,
                      parameters, and performance of large-scale networks. Then
                      we leverage these relations to train networks more
                  ...
                  <div className="principle">
                    ...
                    <p className="text-b2 spacer-micro-mt">
                      ...
                      see larger neural networks which perform better than those
                      that came before. These larger networks also bring new
                      safety challenges. We study and engage with the safety
                      issues of large models so that we can find ways to make
                      them more reliable, share what we learn, and improve safe
                      deployment outcomes across the field. Our immediate focus
                      is prototyping systems that pair these safety techniques
                      with tools for analyzing text and code.
                    </p>
                  </div>
                  ...
                  <div className="principle">
                    ...
                    <p className="text-b2 spacer-micro-mt">
                      ...
                      evaluate and understand the capabilities, limitations, and
                      potential for societal impact of our AI systems. A good
                      way to understand our research direction here is to read
                      about some of the work we’ve led or collaborated on in
                      this space:{" "}
                      <a
                  ...
                  <div className="principle">
                    ...
                    <p className="text-b2 spacer-micro-mt">
                      ...
                      agenda, but we put a lot of emphasis on including everyone
                      — researchers, engineers, societal impact experts and
                      policy analysts — in determining that direction. We look
                      to collaborate with other labs and researchers, as we
                      believe the best research into characterizing these
                      systems will come from a broad community of researchers
                      working together.
                    </p>
                  </div>
                </div>
              ...
              <div className="wrapper">
                ...
                >
                  <div className="search-container">
                    <label className="search-label" htmlFor="post-list-search">
                      <input
                        id="post-list-search"
                        type="text"
                        placeholder="Search"
