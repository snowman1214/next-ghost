            ...
            <div className="careers-container wrapper">
              ...
              <div className="content-blocks">
                    ...
                    <div className="block-lists ">
                      <div className="list ">
                        ...
                        <div className="list-content order-2">
                          ...
                          <ul>
                            ...
                            <li className="text-b2">
                              Unlimited PTO – most staff take between 4-6 weeks
                              each year, sometimes more
                            </li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div className="list ">
                        ...
                        <div className="list-content order-1">
                          ...
                          <p className="text-b2 spacer-micro-mt">
                            ...
                            amounts of equity. Your equity can be multiplied if
                            you choose to donate a portion of it to charity.
                          </p>
                          ...
                          <ul>
                            ...
                            <li className="text-b2">
                              Optional equity donation matching at a 3:1 ratio,
                              up to 50% of your equity grant
                            </li>
                            <li className="text-b2">
                      ...
                      <div className="list ">
                        ...
                        <div className="list-content order-2">
                          ...
                          <p className="text-b2 spacer-micro-mt">
                            We’re continually upgrading our benefits program so
                            we can meet the needs of our entire team.
                          </p>
                  ...
                  <div className="block-content s:col-start-5 s:col-span-8 text-b2 is-bulleted">
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        assignment. These typically involve writing responses to
                        several role-relevant questions; they may occasionally
                        require some outside research. Assignments usually take
                        between 2-5 hours, depending on the role.
                      </li>
                      <li>
                        We include this to minimize bias and make well-informed
                        hiring decisions. We think seeing a candidate’s work
                        helps us assess how they might actually perform on the
                        job; similarly, the assignment gives candidates a better
                        idea of what their work at Anthropic might entail. If a
                        candidate likes working through their take-home, that is
                        one indicator that they would enjoy taking on the role,
                        and vice versa.
                      </li>
                      <li>
                    ...
                    <h2>Team Screen</h2>
                    <p>
                      You'll have a conversation with either the Hiring Manager
                      or a member of your potential team. 
                    </p>
                    <h4>Step 5</h4>
                    ...
                    <ul>
                      ...
                      <li>
                        For operations or policy roles, you’ll have 3-5 hours of
                        interviews, including a culture interview.
                      </li>
                    </ul>
                    <h4>Step 6</h4>
                    <h2>Final Checks</h2>
                    <p>
                      We’ll ask for some references, and have you chat with our
                      leadership.
                    </p>
                    <h4>Step 7</h4>
                    <h2>Offer</h2>
                ...
                >
                  ...
                  <div className="block-content s:col-start-5 s:col-span-8 text-b2 is-bulleted">
                    <p>
                      Technical interviews at Anthropic are broadly categorized
                      into ‘engineering’ or ‘research’ interviews, and each
                      candidate is given a mix tailored to their skillset.
                      <br />
                      <br />
                      Engineering interviews are usually carried out in a shared
                      Python coding environment, like Google Colab. Frontend
                      engineering interviews are in JavaScript. They have the
                      form:
                      <br />
                      Here’s a description of a component from our stack. Could
                      you re-implement a toy version of it for me in one hour?
                      <br />
                      <br />
                      ...
                      <br />
                      <br />
                      We are particularly interested in your thought process and
                      how you attack the problem. You’ll be allowed to look
                      things up with Google, but it’s still important to be
                      familiar with Python syntax and the standard library. We
                      primarily code in Python, and a common reason candidates
                      fail interviews is that they're not fully comfortable in
                      Python.
                      <br />
                      <br />
                      Only one of our engineering interviews touches on machine
                      learning topics, and you can ask to pass on that one if
                      you wish. You do not need to learn anything about machine
                      learning before interviewing as an engineer at Anthropic.
                      <br />
                      <br />
                ...
                >
                  ...
                  <div className="block-content s:col-start-1 s:col-span-12 m:col-start-5 m:col-span-8">
                    <div className="block-lists is-masonry">
                      ...
                      <div className="post ">
                        <div className="h4">
                          Engineers here do lots of research, and researchers do
                          lots of engineering
                        </div>
                        <p className="text-b2 spacer-micro-mt">
                          While there’s historically been a division between
                          engineering and research in machine learning, we think
                          that boundary has dissolved with the advent of large
                          models. The distribution of candidates we interview is
                          strongly bimodal in both engineering and research
                          experience however, and we have necessarily tailored
                          our interview structure to that.
                          <br />
                          <br />
                          - If you’ve an engineering background, please apply as
                          an engineer. You’ll perform much better in the
                          interviews, and if you join you’ll have as much input
                          to Anthropic’s direction and interests as anyone else.
                          <br />
                          <br />- As evidence towards this: all of our papers
                          have engineers as authors, and often as first author.
                          Research and engineering hires all share a single
                      ...
                      <div className="post ">
                        ...
                        <p className="text-b2 spacer-micro-mt">
                          ...
                          contributions to open-source software, put that at the
                          top of your resume!
                        </p>
                      </div>
                      ...
                      <div className="post ">
                        ...
                        <p className="text-b2 spacer-micro-mt">
                          ...
                          operations roles are especially difficult to support.
                          But if we make you an offer, we will make every effort
                          to get you into the United States, and we retain an
                      ...
                      <div className="post ">
                        ...
                        <p className="text-b2 spacer-micro-mt">
                          Once you’re eligible, we’re also keen to sponsor green
                          cards!
                        </p>
                      </div>
                      ...
                      <div className="post ">
                        ...
                        <p className="text-b2 spacer-micro-mt">
                          About half of Anthropic technical staff have a PhD of
                      ...
                      <div className="post ">
                        ...
                        <p className="text-b2 spacer-micro-mt">
                          All our interviews are conducted over Google Meet. We
                          prefer PST office hours, but we can be flexible if
                      ...
                      <div className="post ">
                        ...
                        <p className="text-b2 spacer-micro-mt">
                          ...
                          sorry - we’re a small team and sometimes we get a lot
                          of applicants. We’ll email you when we’ve made a
                          decision.
                        </p>
                      </div>
                      ...
                      <div className="post ">
                        ...
                        <p className="text-b2 spacer-micro-mt">
                          Anthropic staff all come to the office regularly. Most
                          staff live in the Bay Area, though a few live further
                          away and come in for one week a month. We also
                          understand that moving can take time, so as a
                      ...
                      >
                        <div className="role-post s:col-start-5 s:col-span-6">
                          ...
                          <p className="text-b2 spacer-micro-mt">
                            ...
                            infrastructure, whether that’s building large-scale
                            distributed systems, improving the robustness and
                            reliability of large langua…
                          </p>
                          <a
                        ...
                        <div className="role-post s:col-start-5 s:col-span-6">
                          ...
                          <p className="text-b2 spacer-micro-mt">
                            ...
                            can work in the UK time zone. You'll ensure the high
                            availability and performance of our Kubernetes
                      ...
                      >
                        <div className="role-post s:col-start-5 s:col-span-6">
                          ...
                          <p className="text-b2 spacer-micro-mt">
                            ...
                            management, device configuration and deployment, and
                            user support. Successful candidates will have
                        ...
                        <div className="role-post s:col-start-5 s:col-span-6">
                          ...
                          <p className="text-b2 spacer-micro-mt">
                            ...
                            regulatory compliance. You understand how to develop
                            engineering for privacy and compliance controls
                            while minimizing friction for staff, particularly
                            our engineers and produc…
                          </p>
                          <a
                            className="btn-primary spacer-small-mt"
                        ...
                        <div className="role-post s:col-start-5 s:col-span-6">
                          ...
                          <p className="text-b2 spacer-micro-mt">
                            You want to protect Anthropic's most valuable assets
                            from both opportunists and nation states. You live
                            in a Secure by Design mindset, and understand how to
                            communicate that vision to software engineers and
                            leaders. You under…
                          </p>
                          <a
                            className="btn-primary spacer-small-mt"
                    ...
                    <div id="role-container-9" className="role-container">
                      ...
                      >
                        ...
                        <div className="role-post s:col-start-5 s:col-span-6">
                          ...
                          <p className="text-b2 spacer-micro-mt">
                            Note: This is an "evergreen" role that we keep open
                            on an ongoing basis. We receive many applications
                            for this position, and you may not hear back from us
                            directly if we do not currently have an open role on
                            any of our teams…
                          </p>
                          <a
                            className="btn-primary spacer-small-mt"
                      ...
                      >
                        <div className="role-post s:col-start-5 s:col-span-6">
                          ...
                          <p className="text-b2 spacer-micro-mt">
                            ...
                            interpretable, and steerable AI systems. We want AI
                            to be safe and beneficial for our customers and for
                            society as a whole. Our quickly growing business
                            team is a group of committed…
                          </p>
                          <a
                            className="btn-primary spacer-small-mt"
                        ...
                        <div className="role-post s:col-start-5 s:col-span-6">
                          ...
                          <p className="text-b2 spacer-micro-mt">
                            ...
                            interpretable, and steerable AI systems. We want AI
                            to be safe and beneficial for our customers and for
                            society as a whole.As a Trust and Safety policy
                            manager, you will be responsib…
                          </p>
                          <a
                            className="btn-primary spacer-small-mt"
                        ...
                        <div className="role-post s:col-start-5 s:col-span-6">
                          ...
                          <p className="text-b2 spacer-micro-mt">
                            ...
                            interpretable, and steerable AI systems. We want AI
                            to be safe and beneficial for our customers and for
                            society as a whole. As a threat investigator on the
                            Trust and Safety team, you…
                          </p>
                          <a
                            className="btn-primary spacer-small-mt"
                      ...
                      >
                        <div className="role-post s:col-start-5 s:col-span-6">
                          ...
                          <p className="text-b2 spacer-micro-mt">
                            ...
                            interpretable, and steerable AI systems. We want AI
                            to be safe and beneficial for our customers and for
                            society as a whole. Our team is a quickly growing
                            group of committed business…
                          </p>
                          <a
                            className="btn-primary spacer-small-mt"
                      ...
                      >
                        ...
                        <div className="role-post s:col-start-5 s:col-span-6">
                          ...
                          <p className="text-b2 spacer-micro-mt">
                            ...
                            whole.Anthropic’s AI technology is amongst the most
                            capable and safe in the worl…
                          </p>
                          <a
                            className="btn-primary spacer-small-mt"
                        ...
                        <div className="role-post s:col-start-5 s:col-span-6">
                          ...
                          <p className="text-b2 spacer-micro-mt">
                            ...
                            interpretable, and steerable AI systems. We want AI
                            to be safe for our customers and for society as a
                            whole.You care about making safe, steerable,
                        ...
                        <div className="role-post s:col-start-5 s:col-span-6">
                          ...
                          <p className="text-b2 spacer-micro-mt">
                            ...
                            interpretable, and steerable AI systems. We want AI
                            to be safe for our customers and for society as a
                            whole. We are looking for a senior software engineer
                            to join our product team an…
                          </p>
                          <a
                            className="btn-primary spacer-small-mt"
                        ...
                        <div className="role-post s:col-start-5 s:col-span-6">
                          ...
                          <p className="text-b2 spacer-micro-mt">
                            ...
                            interpretable, and steerable AI systems. We want AI
                            to be safe for our customers and for society as a
                            whole. We are looking for software engineers to help
                            build safety and oversight…
                          </p>
                          <a
                            className="btn-primary spacer-small-mt"
                        ...
                        <div className="role-post s:col-start-5 s:col-span-6">
                          ...
                          <p className="text-b2 spacer-micro-mt">
                            ...
                            interpretable, and steerable AI systems. We want AI
                            to be safe for our customers and for society as a
                            whole. Putting our models out in the real world - if
                            done carefully - could help…
                          </p>
                          <a
                            className="btn-primary spacer-small-mt"
                      ...
                      >
                        <div className="role-post s:col-start-5 s:col-span-6">
                          ...
                          <p className="text-b2 spacer-micro-mt">
                            ...
                            interpretable, and steerable AI systems. We want AI
                            to be safe and beneficial for our customers and for
                            society as a whole. As a Public Policy Manager
                    ...
                    <div id="role-container-2" className="role-container">
                      ...
                      >
                        <div className="role-post s:col-start-5 s:col-span-6">
                          ...
                          <p className="text-b2 spacer-micro-mt">
                            Join the team making AI safe.Anthropic is seeking a
                            highly qualified Associate General Counsel to lead
                            commercial and technology transactions at Anthropic.
                            We’ll rely on you to help us develop and negotiate
                            partnerships and c…
                          </p>
                          <a
                            className="btn-primary spacer-small-mt"
                        ...
                        <div className="role-post s:col-start-5 s:col-span-6">
                          ...
                          <p className="text-b2 spacer-micro-mt">
                            Join the team making AI safe.Anthropic is seeking a
                            thoughtful, multidisciplinary product counsel to
                            support our teams building and deploying innovative
                            AI systems and products. As a member of the Product
                            Counsel function, yo…
                          </p>
                          <a
                            className="btn-primary spacer-small-mt"
                      ...
                      >
                        ...
                        <div className="role-post s:col-start-5 s:col-span-6">
                          ...
                          <p className="text-b2 spacer-micro-mt">
                            ...
                            Amodei’s Chief of Staff, and work directly with the
                            leadership team to ensure Anthropic runs smoothly.
                            This is an incredible opportunity to work alongside
                      ...
                      >
                        ...
                        <div className="role-post s:col-start-5 s:col-span-6">
                          ...
                          <p className="text-b2 spacer-micro-mt">
                            ...
                            Accountant to join our growing finance team. In this
                            role, you will manage key accounting processes like
                            accounts payable/receivable, payroll, financial
                            reporting, and fixed as…
                          </p>
                          <a
                            className="btn-primary spacer-small-mt"
                        ...
                        <div className="role-post s:col-start-5 s:col-span-6">
                          ...
                          <p className="text-b2 spacer-micro-mt">
                            ...
                            the future of safe AI! We are looking for our first
                            Strategic Finance and Investor Relations hire to
                            work closely with our executive team. In this
                            critical role, you will deve…
                          </p>
                          <a
                            className="btn-primary spacer-small-mt"
