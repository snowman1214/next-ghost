              ...
              <div className="content-blocks">
                ...
                >
                  ...
                  <div className="block-content s:col-start-5 s:col-span-8">
                    <h2>
                      ...
                      Anthropic is dedicated to building systems that people can
                      rely on and generating research about the opportunities
                      and risks of AI.
                    </h2>
                    ...
                    <div className="block-lists s:grid s:grid-8">
                      <div className="post s:col-start-1 s:col-span-4">
                        ...
                        <p className="text-b2 spacer-micro-mt">
                          ...
                          interpretable, and steerable. We conduct frontier
                          research, develop and apply a variety of safety
                          techniques, and deploy the resulting systems via a set
                          of partnerships and products.
                        </p>
                      </div>
                      ...
                      <div className="post s:col-start-5 s:col-span-4">
                        ...
                        <p className="text-b2 spacer-micro-mt">
                          We treat AI safety as a systematic science, conducting
                          research, applying it to our products, feeding those
                          insights back into our research, and regularly sharing
                      ...
                      <div className="post s:col-start-5 s:col-span-4">
                        ...
                        <p className="text-b2 spacer-micro-mt">
                          ...
                          society, government, academia, nonprofits and industry
                          to promote safety industry-wide.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div className="block-content s:col-start-1 s:col-span-12 m:col-start-5 m:col-span-8">
                    <p className="text-b1">
                      We’re a team of researchers, engineers, policy experts and
                      operational leaders, with experience spanning a variety of
                      disciplines, all working together to build reliable and
                    ...
                    <div className="block-lists s:grid s:grid-12 m:grid-8">
                      <div className="s:col-start-1 s:col-span-6 m:col-start-1 m:col-span-4 spacer-medium-mt">
                        ...
                        <div className="block-list-info">
                          <div className="block-list-heading h3">Research</div>
                          <p className="block-list-description text-b2 spacer-micro-mt">
                            We conduct frontier AI research across a variety of
                            modalities, and explore novel and emerging safety
                            research areas from interpretability to RL from
                            human feedback to policy and societal impacts
                            analysis.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="s:col-start-7 s:col-span-6 m:col-start-5 m:col-span-4 spacer-medium-mt">
                        ...
                        <div className="block-list-info">
                          ...
                          <p className="block-list-description text-b2 spacer-micro-mt">
                            ...
                            policymakers and civil society in the US and abroad
                            to help promote safe and reliable AI.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="s:col-start-7 s:col-span-6 m:col-start-5 m:col-span-4 spacer-medium-mt">
                        ...
                        <div className="block-list-info">
                          ...
                          <p className="block-list-description text-b2 spacer-micro-mt">
                            ...
                            the human engines that make Anthropic go. We’ve had
                            previous careers at NASA, startups, and the armed
                            forces and our diverse experiences help make
                            Anthropic a great place to work (and we love
                            plants!).
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="block-content is-masonry s:col-start-5 s:col-span-8">
                    ...
                    <div className="post">
                      ...
                      <p className="text-b2 spacer-micro-mt">
                        ...
                        studying their behaviors, working to responsibly deploy
                        them, and regularly sharing our safety insights. We
                        collaborate with other projects and stakeholders seeking
                        a similar outcome.
                      </p>
                    </div>
                    ...
                    <div className="post">
                      ...
                      <p className="text-b2 spacer-micro-mt">
                        Collaboration is central to our work, culture, and value
                        proposition. While we have many teams at Anthropic, we
                        feel the broader sense in which we are all on the same
                        team working together towards the mission. Leadership
                        sets the strategy, with broad input from everyone, and
                        trusts each piece of the organization to pursue these
                        goals in their unique style. Individuals commonly
                        contribute to work across many different areas.
                      </p>
                    </div>
                    ...
                    <div className="post">
                      ...
                      <p className="text-b2 spacer-micro-mt">
                        We celebrate trying the simple thing before the clever,
                        novel thing. We embrace pragmatism - sensible, practical
                        approaches that acknowledge tradeoffs. We love
                        empiricism - finding out what actually works by trying
                        it - and apply this to our research, our engineering and
                        our collaboration. We aim to be open about what we
