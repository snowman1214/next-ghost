...
export default function Demand() {
  ...
  return (
    <>
      <NextSeo
        title="Predictability Versus Surprise: The Paradox of Large Generative Models"
        description="SuisseAI's Research on: Predictability Versus Surprise: The Paradox of Large Generative Models."
        openGraph={{
          url: "http://suissegpt.ai",
          title:
            "Predictability Versus Surprise: The Paradox of Large Generative Models",
          description:
            "SuisseAI's Research on: Predictability Versus Surprise: The Paradox of Large Generative Models.",
        }}
      />
      <Header />
                ...
                <div className="wrapper s:grid s:grid-12">
                  ...
                  <div className="post-detail s:col-start-2 s:col-span-10 m:col-start-4 m:col-span-6 l:col-start-5 l:col-span-4 text-b2">
                    ...
                    <div className="b-social-share">
                      <a
                        href="https://www.facebook.com/sharer/sharer.php?u=https://www.suissegpt.ai/predictablemodels"
                        target="_blank"
                        rel="noopener"
                      ...
                      <a
                        href="https://www.linkedin.com/shareArticle?mini=true&amp;url=https://www.suissegpt.ai/predictablemodels"
                        target="_blank"
                        rel="noopener"
                      ...
                      <a
                        href="https://twitter.com/intent/tweet?text=https://www.suissegpt.ai/predictablemodels"
                        target="_blank"
                        rel="noopener"
